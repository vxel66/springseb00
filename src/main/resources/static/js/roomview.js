...
//                               map: map,
//                               content: '<div style="padding:0 5px;background:#fff;">'+position.rnum+'</div>',
...
//                            });
    ...
    function notewrite(rnum){
        var notecontents = $("#ncontents").val();
        alert(rnum); alert(notecontents);

       $.ajax({
           url : "/room/notewrite",
           data : { "rnum" : rnum , "ncontents" : notecontents } ,
           success : function( data ){
                alert(data);
               if( data == 1 ){
